...
~~~sh
# getting the code
git clone git@github.com:nko4/walbril.git && cd ./walbril/

# developing
npm install
npm start

# deploying (to http://walbril.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@walbril.2013.nodeknockout.com
ssh root@walbril.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@walbril.2013.nodeknockout.com
ssh -i ./id_deploy root@walbril.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/walbril" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
